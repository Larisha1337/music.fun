...
// Вспомогательная функция для корректного формирования URL медиафайлов
...
export const GlobalPlayer = () => {
    ...
    return (
        <>
                ...
                <div className="fixed bottom-0 left-0 right-0 z-[100] transition-all duration-700">
                            ...
                            <div className="flex items-center gap-3 w-full sm:w-1/4 min-w-0 shrink-0">
                                ...
                                >
                                    {coverSrc ? (
                                        ...
                                        <svg
                                            className="w-6 h-6 text-zinc-500 fill-current"
                                            viewBox="0 0 16 16"
                                        >
                  ...
                  <span className="text-sm font-bold text-zinc-100 truncate">
                    ...
                    {currentTrack.artist || "Неизвестный исполнитель"}
                            ...
                            {/* Кнопки дополнительных функций: PiP и Закрытие */}
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                ...
                                                strokeWidth={2}
                                                d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"
                                            />
                                        </svg>
                                    </button>
                                )}
            ...
            {/* Портал для отображения плеера внутри выплывающего окна Document Picture-in-Picture */}
            {isPipOpen &&
                renderPip(
